...
1. **Human String** — `YYYY-MM-DD-HH:MM:SS` — Anchor in lived consensus, the breath of presence.

2. **Number String** — `YYYYMMDDHHMMSS` — Spine of digits, the bone of the record.
